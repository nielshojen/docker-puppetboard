...
gunicorn -b 0.0.0.0:${PUPPETBOARD_WEBPORT} puppetboard.app:app --workers="${PUPPETBOARD_WORKERS:-1}" -e SCRIPT_NAME="${PUPPETBOARD_URL_PREFIX:-}" --access-logfile=- /usr/src/app/puppetboard.app:app &
